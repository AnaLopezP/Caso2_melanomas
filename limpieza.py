...
input_dir = 'ruta/a/imagenes_originales/'  # Carpeta de imágenes originales
output_dir = 'ruta/a/imagenes_preprocesadas/'  # Carpeta para guardar imágenes preprocesadas
